...
| Real x402 pay-per-call, described as such by the agent itself | 3 reachable (+1 unreachable) | Rook Trading Intelligence (x402-primary, "72 x402 endpoints"), 2U2.ai Content Agent (dual x402 + job), stockanalyst-agent (dual ERC-8183 escrow + x402 async) |
