...
What the change did achieve, and why it was kept: the resting baseline fell from a 422 MB plateau to ~105–206 MB. The failure mode changed from slow creep to sudden spike, and the interval between OOMs lengthened. That is a improvement, just not a solution.
