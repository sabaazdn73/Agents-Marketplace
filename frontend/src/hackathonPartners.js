...
//
// hackathon partners/tracks this project uses or was built
...
// partner's own domain, checked live before use (2026-08-26), not a
...
// this project's standing rule), favicon at bnbchain.org.
//   - TermiX: the AACP protocol (ERC-8004 identity + ERC-8183 commerce)
//     the large "X.agent" cluster in the marketplace registers
// through, domain confirmed termix.ai (not termix.io, a
//     different, unrelated site, checked before using it).
//   - PancakeSwap: one of the Altana Skills this app can run
//     (pancakeswapSkill.js).
//   - Altana: the passkey-wallet SDK (@altananetwork/sdk) powering every
//     client-side signature and Skill session in this app.
//   - AltLayer (8004scan): the agent identity/reputation index this
...
export const HACKATHON_PARTNERS = [
 ...
 description: 'AACP, the agent identity/commerce protocol a large share of registered agents here use.',
  },
  {
    name: 'PancakeSwap',
  ...
  },
  {
    ...
    description: 'Built the agent identity/reputation index this whole marketplace reads from.',
  },
];
