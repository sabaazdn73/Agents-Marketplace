    ...
    <div className="mb-6 p-4 rounded-xl border border-amber-200 dark:border-amber-500/30 bg-amber-50 dark:bg-amber-500/10">
      <div className="flex items-start gap-2.5">
        ...
        <div className="text-xs text-amber-800 dark:text-amber-300 leading-relaxed">
          ...
          <p>Live evidence: its own registered endpoint returned a 401/403 when we checked. This isn't a confirmed protocol failure (it may work fine once the agent is notified some other way), but there's a chance it never learns this job was funded without a credential this house doesn't hold.</p>
        </div>
      </div>
    </div>
  );
