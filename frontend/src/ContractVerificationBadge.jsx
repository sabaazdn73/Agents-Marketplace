...
// wallet or an smart contract (backend: GET
...
// investigation behind this, including the real, checked prevalence:
// ~8% of real, sampled agent owner addresses are contracts at all).
//
// Deliberately renders NOTHING for the overwhelmingly common case
// (is_contract: false, a plain wallet, nothing to flag) rather than a
// "not applicable" badge that would clutter ~92% of agent detail
...
// contract (reassurance) or an unverified one (a real, risk
