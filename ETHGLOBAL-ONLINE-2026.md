...
Technical detail lives in the [docs](docs/README.md) and is linked from each milestone rather than repeated here.
...
*Detail: [Architecture](docs/architecture.md), [Core Concepts](docs/core-concepts.md), [Verification Methodology](docs/verification-methodology.md), [Full Registry Analysis](docs/full-registry-analysis.md).*
...
*Detail: [The Graph Integration](docs/thegraph-integration.md).*
